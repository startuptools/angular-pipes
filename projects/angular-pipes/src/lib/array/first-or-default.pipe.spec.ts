...
describe('FirstOrDefaultPipe', () => {
  ...
  it('Should return the objects where a is 4', () => {
    ...
    expect(pipe.transform(array, fn)).toEqual({
      a: 4,
      b: 3,
      d: { e: 8 },
    });
  ...
  it('Should return the objects where a is 4', () => {
    expect(pipe.transform(array, ['a', 4])).toEqual({
      a: 4,
      b: 3,
      d: { e: 8 },
    });
  ...
  it('Should return the objects where d.e is 4', () => {
    expect(pipe.transform(array, ['d.e', 4])).toEqual({
      a: 2,
      b: 3,
      d: { e: 4 },
    });
  ...
  it('Should return the default value', () => {
    expect(pipe.transform([1, 2, 3], (item: number) => item === 4, 5)).toEqual(5);
  });

  it('Should not return the default value', () => {
    expect(pipe.transform([1, 2, 3], (item: number) => item === 4)).toBeUndefined();
  });
});
